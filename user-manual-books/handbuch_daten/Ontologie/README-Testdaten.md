...
| `ontology.yaml` | 26 Klassen, 32 Relationen | Ontologie des Korpus: Klassen, Relationen, Enums, Identitätsregeln, deutsche Ankertexte, Provenienz, Kompetenzfragen |
| `ontology_to_pydantic.py` | — | Prüft die Ontologie und erzeugt daraus das Pydantic-v2-Modell |
| `ontology_model.py` | 477 Zeilen | erzeugtes Modell (Enums, Knotenklassen, diskriminierte Union, `GraphDocument`) |
